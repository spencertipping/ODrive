...
const Endpoint endpoints[] = {
    ...
    Endpoint::make_object("motor0"),
        ...
        Endpoint::make_object("sensorless"),
            Endpoint::make_property("phase", &motors[0].sensorless.phase),
            Endpoint::make_property("pll_pos", &motors[0].sensorless.pll_pos),
            Endpoint::make_property("pll_delta", &motors[0].sensorless.pll_delta),
            Endpoint::make_property("pll_vel", &motors[0].sensorless.pll_vel),
            Endpoint::make_property("pll_kp", &motors[0].sensorless.pll_kp),
            Endpoint::make_property("pll_ki", &motors[0].sensorless.pll_ki),
            Endpoint::make_property("observer_gain", &motors[0].sensorless.observer_gain),
            Endpoint::make_property("flux_state_x", &motors[0].sensorless.flux_state[0]),
            Endpoint::make_property("flux_state_y", &motors[0].sensorless.flux_state[1]),
            Endpoint::make_property("pm_flux_linkage", &motors[0].sensorless.pm_flux_linkage),
            Endpoint::make_property("alpha_mem", &motors[0].sensorless.V_alpha_beta_memory[0]),
            Endpoint::make_property("beta_mem", &motors[0].sensorless.V_alpha_beta_memory[1]),
        Endpoint::close_tree(),
